...
import { ExecuteTransferController } from '../modules/statements/useCases/executeTransfer/ExecuteTransferController';
...
const executeTransferController = new ExecuteTransferController();
...
statementRouter.post('/transfer/:destiny_user_id', executeTransferController.execute);
